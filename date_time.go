...
type DateTime struct {
	// The timestamp in ISO 8601 format. This value is always in UTC time.
	Value string `json:"value"`
	// The TZ database timezone
	Timezone string `json:"timezone"`
}

const DateTimeAvroCRC64Fingerprint = "h5\x87\x99\x19\f\x19\x02"
...
func (r DateTime) Schema() string {
	return "{\"fields\":[{\"doc\":\"The timestamp in ISO 8601 format. This value is always in UTC time.\",\"name\":\"value\",\"type\":{\"avro.java.string\":\"String\",\"type\":\"string\"}},{\"doc\":\"The TZ database timezone\",\"name\":\"timezone\",\"type\":{\"avro.java.string\":\"String\",\"type\":\"string\"}}],\"name\":\"com.kroger.desp.commons.kcp.postorder.ratings.DateTime\",\"type\":\"record\"}"
}

func (r DateTime) SchemaName() string {
	return "com.kroger.desp.commons.kcp.postorder.ratings.DateTime"
}
